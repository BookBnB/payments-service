...
Característica:
    ...
    Escenario: Creación fallida - Cupo alcanzado
        ...
        Y el usuario '8e590c31-8bbc-4fae-80ea-77e3a4cfc628' crea una reserva del '2020-12-01' al '2020-12-10'
        Y el usuario '94728c1c-6972-44eb-926a-54fa9be50f22' crea una reserva del '2020-12-01' al '2020-12-10'
        Y el usuario 'c7bd0e91-8052-4725-94eb-e5e85d969e1c' crea una reserva del '2020-12-01' al '2020-12-10'
        Y el usuario '1dc34545-83d9-4e80-96cc-b58585b8fac7' crea una reserva del '2020-12-01' al '2020-12-10'
        Y el usuario 'bfd35377-ff03-4c6f-81f9-0d69069e3060' crea una reserva del '2020-12-01' al '2020-12-10'
        Cuando el usuario '149d79bf-39e0-4acb-8ac5-aa3d3006e49a' crea una reserva del '2020-12-01' al '2020-12-10'
